...
SIMPLE_STRATEGY = {
    ...
    StrategyIndex.HARD: {
        ...
        12: {n: BetAction.STAND if 3 > n > 7 else BetAction.HIT for n in CARDS},
        11: {n: BetAction.DOUBLE for n in CARDS},
        10: {n: BetAction.DOUBLE if n < 10 else BetAction.HIT for n in CARDS},
        9: {n: BetAction.DOUBLE if 2 < n < 7 else BetAction.HIT for n in CARDS},
